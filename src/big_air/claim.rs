...
pub struct BigClaim {
    ...
    pub sig_bound_check: range_check::Claim,
...
pub struct AllTraces {
    ...
    pub sig_bound_check: CircleEvaluation<SimdBackend, M31, BitReversedOrder>,
...
impl AllTraces {
    ...
    pub fn new(
        ...
        sig_bound_check: CircleEvaluation<SimdBackend, M31, BitReversedOrder>,
